...
degree_df = pd.read_csv('/mnt/altnas/work/Kyle.Knightly/leq200mb-hepg2-anchor-degrees.bed', sep='\t', names = ['chr', 'start', 'end', 'degree'])
df = pd.read_csv('/mnt/altnas/work/Kyle.Knightly/leq200mb-anchor-TFs.bed', sep='\t', names=['chr', 'start','end', 'prots'])
graph = nx.read_gpickle('/mnt/altnas/work/Kyle.Knightly/leq200mb-hepg2-anchor-graph.gpickle')
...
print(final_df)
final_df.to_csv('leq200mb-protein-degree-tests.tsv', sep='\t', index=False)